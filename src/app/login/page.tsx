    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center py-12 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl grid lg:grid-cols-2 gap-8 items-center relative z-10">
        ...
        >
          ...
          <motion.h1
            className="font-sora text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight"
          ...
          <div className="space-y-4">
            {[
              ...
              >
                <motion.div
                  className="flex h-6 w-6 items-center justify-center rounded-full bg-[#22C55E]/20"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
              ...
              <CardContent className="p-6 lg:p-8 space-y-4">
                ...
                >
                  <Button
                    ...
                    className="w-full hover:bg-[#4285F4]/10"
                  >
                  ...
                  <Button
                    ...
                    className="w-full hover:bg-[#1877F2]/10"
                  >
