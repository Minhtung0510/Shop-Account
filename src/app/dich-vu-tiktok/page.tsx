...
export default function TikTokServicesPage() {
  ...
  const { data: services = [] } = useServices("TikTok");
  ...
  return (
    <div className="min-h-screen py-8">
      <div className="mx-auto max-w-[1200px] px-4 lg:px-6">
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#25F4EE]/30 bg-[#25F4EE]/10 px-4 py-1.5 text-sm text-[#25F4EE] mb-4">
            <Music className="h-4 w-4" />
            Dịch vụ TikTok
          </div>
          <h1 className="font-sora text-3xl lg:text-4xl font-bold text-white mb-2">
            Dịch vụ hỗ trợ TikTok
          </h1>
          <p className="text-[#94A3B8]">
            Các dịch vụ hỗ trợ tài khoản TikTok chuyên nghiệp
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-12">
          {[
            ...
            <div key={i} className="rounded-[14px] border border-[#1E293B] bg-[#111827] p-4 text-center">
              <item.icon className="h-6 w-6 text-[#25F4EE] mx-auto mb-2" />
            ...
            <Card key={service.id} hover className="group cursor-pointer">
              <CardContent className="p-6">
                <div className="flex gap-4 mb-4">
                  <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-[14px] bg-gradient-to-br from-[#000000] to-[#25F4EE]">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-sora text-xl font-bold text-[#25F4EE]">
        ...
        <div className="mt-12 rounded-[18px] border border-[#1E293B] bg-[#111827] p-8 text-center">
          ...
          <p className="text-[#94A3B8] mb-6">
            Liên hệ với chúng tôi để được tư vấn dịch vụ TikTok theo nhu cầu riêng
          </p>
          <Link href="/lien-he">
            <Button>
              <Music className="h-4 w-4" />
